...
int main(int argc, char* argv[]) {
	...
	// 			fwrite(&row, 1, 1, file);
	// 			fwrite(&col, 1, 1, file);
	// 			uint8_t r = (col % 3 == 0) * 255;
	// 			uint8_t g = (col % 3 == 1) * 255;
	// 			uint8_t b = (col % 3 == 2) * 255;
	// 			// uint8_t r = (col % 3 == frame) * 255;
	// 			// uint8_t g = (col % 3 == (frame+1) % 3) * 255;
	// 			// uint8_t b = (col % 3 == (frame+2) % 3) * 255;
